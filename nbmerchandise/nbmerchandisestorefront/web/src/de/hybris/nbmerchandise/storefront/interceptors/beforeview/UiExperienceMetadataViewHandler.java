 ...
 *  
 */
package de.hybris.nbmerchandise.storefront.interceptors.beforeview;

import de.hybris.platform.commerceservices.enums.UiExperienceLevel;
import de.hybris.platform.acceleratorservices.storefront.data.MetaElementData;
import de.hybris.platform.acceleratorservices.uiexperience.UiExperienceService;
import de.hybris.nbmerchandise.storefront.interceptors.BeforeViewHandler;
...
public class UiExperienceMetadataViewHandler implements BeforeViewHandler
{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.hybris.nbmerchandise.storefront.interceptors.BeforeViewHandler#beforeView(javax.servlet.http.
