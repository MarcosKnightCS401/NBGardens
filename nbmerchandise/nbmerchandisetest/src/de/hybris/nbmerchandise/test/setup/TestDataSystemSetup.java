 ...
 *  
 */
package de.hybris.nbmerchandise.test.setup;
...
import de.hybris.nbmerchandise.test.constants.NbmerchandiseTestConstants;
import de.hybris.nbmerchandise.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = NbmerchandiseTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/nbmerchandisetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/nbmerchandisetest/import/reviews.impex");
			...
			importImpexFile(context, "/nbmerchandisetest/import/cstickets.impex");
		}
	}
}
