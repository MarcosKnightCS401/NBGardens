...
import de.hybris.nbmerchandise.fulfilmentprocess.test.actions.TestActionTemp;
...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception //NOPMD
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/nbmerchandisefulfilmentprocess/test/nbmerchandisefulfilmentprocess-spring-test.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/nbmerchandisefulfilmentprocess/test/nbmerchandisefulfilmentprocess-spring-test-fraudcheck.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/nbmerchandisefulfilmentprocess/test/process/order-process-spring.xml"));
		...
		definitonFactory.add("classpath:/nbmerchandisefulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/nbmerchandisefulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/nbmerchandisefulfilmentprocess/test/testCatalog.csv", "windows-1252");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/nbmerchandisefulfilmentprocess/test/nbmerchandisefulfilmentprocess-spring-testcleanup.xml"));
