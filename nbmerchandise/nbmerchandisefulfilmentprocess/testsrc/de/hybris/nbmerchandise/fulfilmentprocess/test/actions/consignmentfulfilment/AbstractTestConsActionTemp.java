 ...
 *  
 */
package de.hybris.nbmerchandise.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, NbmerchandiseFulfilmentProcessConstants.PARENT_PROCESS);
