 ...
 *  
 */
package de.hybris.nbmerchandise.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(NbmerchandiseFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(NbmerchandiseFulfilmentProcessConstants.PARENT_PROCESS);
