 ...
 *  
 */
package de.hybris.nbmerchandise.fulfilmentprocess.test;
...
import de.hybris.nbmerchandise.fulfilmentprocess.constants.NbmerchandiseFulfilmentProcessConstants;
import de.hybris.nbmerchandise.fulfilmentprocess.test.events.TestEventListenerCountingEvents;
...
public class FraudCheckIntegrationTest extends ServicelayerTest
{
	...
	/**
	 * Load bean definition from nbmerchandisefulfilmentprocess-spring-test-fraudcheck.xml
	 */
	@BeforeClass
	public static void beforeClass()
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/nbmerchandisefulfilmentprocess/test/nbmerchandisefulfilmentprocess-spring-test-fraudcheck.xml"));
	...
	protected static final String PARAM_NAME_MIN_PERIOD_WAITING_FOR_CLEANUP_IN_SECONDS = "nbmerchandisefulfilmentprocess.fraud.minPeriodWaitingForCleanUpInSeconds";
	protected static final String PARAM_NAME_FRAUD_SCORE_LIMIT = "nbmerchandisefulfilmentprocess.fraud.scoreLimit";
	protected static final String PARAM_NAME_FRAUD_SCORE_TOLERANCE = "nbmerchandisefulfilmentprocess.fraud.scoreTolerance";
	...
	public void before() throws Exception
	{
		...
		{
			importCsv("/nbmerchandisefulfilmentprocess/test/testTicketEssentialData.csv", "utf-8");
		}
		importCsv("/nbmerchandisefulfilmentprocess/test/testWarehouses.csv", "utf-8");
	...
	{
		final String processDefinitionName = NbmerchandiseFulfilmentProcessConstants.ORDER_PROCESS_NAME;
	...
	protected String submitOrderMock(final OrderModel order)
	{
		final OrderProcessModel businessProcessModel = (OrderProcessModel) businessProcessService.createProcess(
				NbmerchandiseFulfilmentProcessConstants.ORDER_PROCESS_NAME + order.getCode() + +System.currentTimeMillis(),
				NbmerchandiseFulfilmentProcessConstants.ORDER_PROCESS_NAME);
