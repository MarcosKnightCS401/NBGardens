 ...
 *  
 */
package de.hybris.nbmerchandise.cockpits.setup;
...
import de.hybris.nbmerchandise.cockpits.constants.NbmerchandiseCockpitsConstants;
 ...
 */
@SystemSetup(extension = NbmerchandiseCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(NbmerchandiseCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(NbmerchandiseCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						NbmerchandiseCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				importImpexFile(context, "/nbmerchandisecockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
			}
