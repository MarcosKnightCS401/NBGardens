 ...
 *  
 */
package de.hybris.nbmerchandise.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("nbmerchandisecockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("nbmerchandisecockpits.product.externalTaxes"));
