 ...
 *  
 */
package de.hybris.nbmerchandise.core.hmc;
...
/**
 * Provides necessary meta information about the nbmerchandisecore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class NbmerchandiseCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(NbmerchandiseCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "de.hybris.nbmerchandise.core.hmc.locales";
