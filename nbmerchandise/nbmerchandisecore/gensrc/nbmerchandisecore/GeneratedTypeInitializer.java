...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			"ApparelProduct",
			"Product",
			de.hybris.nbmerchandise.core.jalo.ApparelProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"VariantProduct",
			de.hybris.nbmerchandise.core.jalo.ApparelStyleVariantProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"ApparelStyleVariantProduct",
			de.hybris.nbmerchandise.core.jalo.ApparelSizeVariantProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"VariantProduct",
			de.hybris.nbmerchandise.core.jalo.ElectronicsColorVariantProduct.class,
			null,
			false,
			null,
			false
