...
import de.hybris.nbmerchandise.core.jalo.ApparelProduct;
import de.hybris.nbmerchandise.core.jalo.ApparelSizeVariantProduct;
import de.hybris.nbmerchandise.core.jalo.ApparelStyleVariantProduct;
import de.hybris.nbmerchandise.core.jalo.ElectronicsColorVariantProduct;
...
/**
 * Generated class for type <code>NbmerchandiseCoreManager</code>.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedNbmerchandiseCoreManager extends Extension
{
	...
	public ApparelProduct createApparelProduct(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( NbmerchandiseCoreConstants.TC.APPARELPRODUCT );
	...
	public ApparelSizeVariantProduct createApparelSizeVariantProduct(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( NbmerchandiseCoreConstants.TC.APPARELSIZEVARIANTPRODUCT );
	...
	public ApparelStyleVariantProduct createApparelStyleVariantProduct(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( NbmerchandiseCoreConstants.TC.APPARELSTYLEVARIANTPRODUCT );
	...
	public ElectronicsColorVariantProduct createElectronicsColorVariantProduct(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( NbmerchandiseCoreConstants.TC.ELECTRONICSCOLORVARIANTPRODUCT );
	...
	{
		return NbmerchandiseCoreConstants.EXTENSIONNAME;
	}
	...
	{
		return (Boolean)item.getProperty( ctx, NbmerchandiseCoreConstants.Attributes.Product.INTERNALONLY);
	}
	...
	{
		item.setProperty(ctx, NbmerchandiseCoreConstants.Attributes.Product.INTERNALONLY,value);
	}
